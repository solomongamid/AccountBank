...
class TransactionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $transactions = $em->getRepository('AccountBundle:Transaction')->findAll();
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('AccountBundle\Form\TransactionType', $transaction);
    ...
    {
        $deleteForm = $this->createDeleteForm($transaction);
        $editForm = $this->createForm('AccountBundle\Form\TransactionType', $transaction);
